...
(function (Type) {
    var Numeric = /** @class */ (function (_super) {
        ...
        Numeric.prototype.GTE = function (value) {
            this.lf = true;
            if (this.TYPE >= value.TYPE) {
        ...
        Numeric.prototype.LT = function (value) {
            this.lf = true;
            if (this.TYPE >= value.TYPE) {
        ...
        Numeric.prototype.LTE = function (value) {
            this.lf = true;
            if (this.TYPE >= value.TYPE) {
        ...
        Numeric.prototype.EQ = function (value) {
            this.lf = true;
            if (this.TYPE >= value.TYPE) {
        ...
        Numeric.prototype.NEQ = function (value) {
            this.lf = true;
            if (this.TYPE >= value.TYPE) {
        ...
        Numeric.prototype.trusty = function () {
...
var Fcal = /** @class */ (function () {
    ...
    Fcal.UseUnits = function (units) {
        for (var _i = 0, units_3 = units; _i < units_3.length; _i++) {
            var unit = units_3[_i];
            this.UseUnit(unit);
        }
    };
    ...
    Fcal.UseUnit = function (unit) {
        ...
        var u = new units_2.Unit(unit.id, unit.ratio, unit.type, unit.phrases);
        if (unit.bias) {
            u.setBias(unit.bias);
        }
        if (unit.plural) {
     ...
     */
    Fcal.getTokensForExpression = function (expression) {
        var lexer = new lex_1.Lexer(expression, this.phrases, this.units, this.converters, this.scales);
     ...
     */
    Fcal.prototype.getEnvironment = function () {
...
var Expression = /** @class */ (function () {
     ...
     */
    Expression.prototype.getValues = function () {
     ...
     */
    Expression.prototype.getScannedTokens = function () {
...
var Evaluator = /** @class */ (function () {
    ...
    Evaluator.prototype.getScannedTokens = function () {
        var _a;
...
var Parser = /** @class */ (function () {
    ...
    Parser.prototype.getScannedTokens = function () {
        return this.tokens;
    };
